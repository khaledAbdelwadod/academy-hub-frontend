/** A compact "..." menu for per-row actions in the Users table. */
...
export function RowActionsMenu({ user, onEdit, onToggleActive, onDelete }: RowActionsMenuProps): ReactElement {
