/** A compact "..." menu for a team's own actions - matches the kebab menu used elsewhere. */
...
export function TeamActionsMenu({ onEdit, onDelete }: TeamActionsMenuProps): ReactElement {
