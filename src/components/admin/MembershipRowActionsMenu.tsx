    ...
    <div className="relative inline-block">
      ...
      {open && (
        <>
          ...
          />
          <div className="absolute right-0 top-[calc(100%+6px)] z-20 w-44 overflow-hidden rounded-xl border border-mint bg-white shadow-[0_24px_50px_-22px_rgba(0,0,0,0.35)]">
            <button
              type="button"
              onClick={() => {
                onAssignManager();
