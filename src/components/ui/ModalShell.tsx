...
export function ModalShell({
  ...
  return (
    <div className="fixed inset-0 z-30 flex items-center justify-center overflow-y-auto bg-black/60 px-4 py-10">
      ...
      <div
        className={`relative w-full rounded-[22px] border border-mint bg-white/40 p-6 shadow-[0_24px_50px_-22px_rgba(0,0,0,0.35)] backdrop-blur-2xl sm:p-8 ${maxWidthClassName}`}
      >
        <button
          type="button"
          aria-label="Close"
